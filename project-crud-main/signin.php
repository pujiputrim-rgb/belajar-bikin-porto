...
if (isset($_POST['login'])) {
  ...
  if ($email == "kacang@gmail.com" && $pass == "123") {
...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="assest/inapp-1.0.0/src/assets/images/favicon_io/apple-touch-icon.png">
  <link rel="icon" type="image/png" sizes="32x32" href="assest/inapp-1.0.0/src/assets/images/favicon_io/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="assest/inapp-1.0.0/src/assets/images/favicon_io/favicon-16x16.png">
  <link rel="manifest" href="assest/inapp-1.0.0/src/assets/images/favicon_io/site.webmanifest">
    ...
    <div class="card " style="max-width:420px; width:100%;">
      <div class="card-body p-5">
        <div class="text-center mb-3">
          <a href="index.html" class="mb-4 d-inline-block"><img src="assest/inapp-1.0.0/src/assets/images/logo-icon.svg" alt="" width="36">
            <span class=" ms-2"> <img src="assest/inapp-1.0.0/src/assets/images/logo.svg" alt=""></span>
          </a>
