						...
						<div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
							...
							<div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
								<div class="text">
									...
									<h2 class="mb-1 text-light"><?= $v['subtitle'] ?></h2>
									<p class="mb-4 text-light"><?= $v['description'] ?></p>
									<p><a href="<?= $v['button1_link'] ?>" class="btn btn-primary py-3 px-4"><?= $v['button1_text'] ?></a>
										<a href="<?= $v['button2_link'] ?>" class="btn btn-white 
									btn-outline-white py-3 px-4"><?= $v['button2_text'] ?></a>
									</p>
								</div>
							</div>
						</div>
