...
if (isset($_GET['delete'])) {
  ...
  $img = mysqli_query($conn, "SELECT image FROM blog WHERE id='$delete'");
  ...
  $delete = mysqli_query($conn, "DELETE FROM blog WHERE id='$delete'");
  header("location:app.php?page=blog&hapus=berhasil");
}
...
<div
  ...
  <div class="ms-md-auto py-2 py-md-0">
    ...
    <a href="app.php?page=create-blog" class="btn btn-primary btn-round">Create New Blog Post</a>
  </div>
</div>
<div class="row">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a onclick="return confirm('Are you sure want to delete this data?')"
                    ...
                    href="app.php?page=blog&delete=<?php echo $row['id'] ?>">Delete</a>
                </td>
              </tr>
            <?php endforeach ?>
          </tbody>
