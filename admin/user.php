...
<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
  ...
  <div class="ms-md-auto py-2 py-md-0">
    <!-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a> -->
      </head><a href="app.php?page=create-user" class="btn btn-primary btn-round">Create New User</a>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6 col-md-12">
    <div class="card">
      <div class="card-body">
        <table class="table table-bordered table-striped" id="myTable"> <!-- bordered = warna border, striped = warna ganjil genap bisa beda tablenya -->
          <thead>
            <tr>
              <th>No</th>
              <th>Name</th>
